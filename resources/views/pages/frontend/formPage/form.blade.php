            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start bg-white rounded-2xl shadow-lg">
                ...
                <div class="h-full p-6 overflow-hidden">
                    ...
                    <div class="relative bg-[#DFAC37] text-white rounded-2xl p-6 h-[600px] overflow-hidden">
                        ...
                        <!-- Phone -->
                        <div class="mb-6 flex flex-col md:flex-row items-start gap-4">
                            <div class="mt-1">
                            ...
                            <div>
                                <p class="md:text-lg">(0542) 8511122</p>
                                <p class="md:text-lg">(0542) 736277</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 flex flex-col md:flex-row items-start gap-4">
                            ...
                            <p class="md:text-lg pr-20">marketing@kasaugrup.com</p>
                        </div>
                        ...
                        <div class="mb-8 flex flex-col md:flex-row items-start gap-4">
                            ...
                            <p class="md:text-lg">
                                PT. Kasau Sinar Samudera, Komplek Balikpapan Baru B5, Balikpapan Selatan, Kalimantan
                                Timur.
                            </p>
                        </div>
                        
                        <img src="{{ asset('img/kasau/Buble.svg') }}" alt="Bubble"
                            class="absolute bottom-0 right-0 hidden sm:block w-24 sm:w-40 md:w-56 lg:w-72 max-w-full" />
                        ...
                        <div class="absolute bottom-0 left-0 flex gap-4 p-6">
                            ...
                            <!-- Instagram -->
                            <a href="https://www.instagram.com/kasaugroup_/"
                            ...
                            <!-- LinkedIn -->
                            <a href="https://www.linkedin.com/company/kasaugroup/"
                                class="hover:text-orange-200 transition-colors">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                            ...
                            <!-- YouTube -->
                            <a href="https://www.youtube.com/@Kasaugroup" class="hover:text-orange-200 transition-colors">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}"
                                        class="w-full py-2 border-b-2 border-gray-300 focus:border-black focus:outline-none bg-transparent focus:transition-colors duration-300 @error('first_name') is-invalid @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}"
                                        class="w-full py-2 border-b-2 border-gray-300 focus:border-black focus:outline-none bg-transparent focus:transition-colors duration-300 @error('last_name') is-invalid @enderror"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}"
                                        class="w-full py-2 border-b-2 border-gray-300 focus:border-black focus:outline-none bg-transparent focus:transition-colors duration-300 @error('email') is-invalid @enderror"
                                        placeholder="Email">
                                    @error('email')
                                        <div class="invalid-feedback text-red-700">
                                            {{ $message }}
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}"
                                        class="w-full py-2 border-b-2 border-gray-300 focus:border-black focus:outline-none bg-transparent focus:transition-colors duration-300 @error('phone') is-invalid @enderror"
                            ...
                            <div>
                                ...
                                <div>
                                    <textarea id="message" name="message" rows="4"
                                        class="w-full py-2 border-b-2 border-gray-300 focus:border-black focus:outline-none bg-transparent focus:transition-colors duration-300 @error('message') is-invalid @enderror"
