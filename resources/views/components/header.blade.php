...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg {{ $unread > 0 ? 'beep' : '' }}"><i class="far fa-bell"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    @forelse(auth()->user()->unreadNotifications as $notification)
                        <a href="{{ route('notifications.handle', $notification->id) }}"
                            ...
                            <div class="dropdown-item-desc">
                                ...
                                <div class="time text-primary">
                                    {{ \Carbon\Carbon::parse($notification->data['submitted_at'])->diffForHumans() }}
                                </div>
                            </div>
                        </a>
                    @empty
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('user-profile-information.update') }}" class="dropdown-item has-icon">
